        ...
        <div class="card">
            <form action="<?= base_url('user/update_foto') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body text-center">
                    <img src="<?= base_url('assets/img/profil/' . $user->foto) ?>" alt="Foto Profil" id="img-foto" class="d-fluid w-75">
                </div>
                <div class="card-footer">
                    <div class="custom-file mb-3">
                        <input type="file" name="foto" class="custom-file-input" id="input-foto" aria-describedby="input-foto" accept="image/*" onchange="loadFile(event)">
...
<script>
  var loadFile = function(event) {
    var output = document.getElementById('img-foto');
