...
<head>
    ...
    <title>Absensi JokiNgoding</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo_joki.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2019 <a href="https://www.instagram.com/jokingoding/">Jokingoding</a> 
                        </p>
                    </nav>
                </div>
            </footer>
